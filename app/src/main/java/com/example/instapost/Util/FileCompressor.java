package com.example.instapost.Util;
...
public class FileCompressor {
    ...
    public FileCompressor(Context context) {
        destDirectoryPath = context.getCacheDir().getPath() + File.separator + "images";
    }
    ...
    public File compressToFile(File imageFile, String compressedFileName) throws IOException {
        return compressImage(imageFile, maxWidth, maxHeight, compressFormat, quality,
                destDirectoryPath + File.separator + compressedFileName);
    }
